...
//        contentValues.put("room_id", room_id);
    ...
    public ArrayList<com.example.daredevil07.ItsShowTime.Show> getShows(String title) {
        String sql = "SELECT * FROM show WHERE title LIKE '" + title + "';";

        ArrayList<com.example.daredevil07.ItsShowTime.Show> showList = new ArrayList<>();
...
//            int room_id = cursor.getInt(cursor.getColumnIndex("room_id"));
            ...
            com.example.daredevil07.ItsShowTime.Show show = new com.example.daredevil07.ItsShowTime.Show(show_id, time, date);
            showList.add(show);
            cursor.moveToNext();
        }
    ...
    public com.example.daredevil07.ItsShowTime.Show getDateTime(int show_id) {
        ...
        com.example.daredevil07.ItsShowTime.Show show = new com.example.daredevil07.ItsShowTime.Show(show_id, cursor.getString(cursor.getColumnIndex("time")), cursor.getString(cursor.getColumnIndex("date")));
    ...
    public ArrayList<Ticket> getAllTickets() {
        ...
        ArrayList<com.example.daredevil07.ItsShowTime.Ticket> ticketArrayList = new ArrayList<>();
        Cursor cursor = db.rawQuery(sql,null);
        ...
        while (!cursor.isAfterLast()) {
            ...
            com.example.daredevil07.ItsShowTime.Ticket ticket = new com.example.daredevil07.ItsShowTime.Ticket(seatinfo, date, time, filmtitle);
