...
public class Room {
    ...
    private int row;
    private int col;
    private ArrayList<com.example.daredevil07.ItsShowTime.Seat> seats;
...
//
        ...
        for (int i = 0; i < ROW; i++){
            ...
            for (int j = 0; j < COL; j++){
                ...
                final com.example.daredevil07.ItsShowTime.Seat seat = new com.example.daredevil07.ItsShowTime.Seat(context, i, j);
    ...
    private void seatButtonClicked(com.example.daredevil07.ItsShowTime.Seat seat, int row, int col) {
//        Toast.makeText(this, "Button clicked " + row + " " + col, Toast.LENGTH_SHORT).show();
        seat.setBackground();
    }

    private Boolean addSeat (com.example.daredevil07.ItsShowTime.Seat seat){
        if (seat.IsBooked()){
            return false;
        }
    ...
    public double calculate(ArrayList<com.example.daredevil07.ItsShowTime.Seat>seats){
        double price = 0;
        for(com.example.daredevil07.ItsShowTime.Seat seat: seats){
            price += seat.getPrice();
        }
        return price;
    }
