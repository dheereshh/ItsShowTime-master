...
//        Picasso.with(holder.itemView.getContext()).load(listItem.getImageURL()).into(holder.imageView);
        ...
        holder.textTitle.setText(String.valueOf(film.getTitle()));
        ...
        holder.itemListView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent itemDetailIntent = new Intent(view.getContext().getApplicationContext(), com.example.daredevil07.ItsShowTime.FilmDetailActivity.class);
