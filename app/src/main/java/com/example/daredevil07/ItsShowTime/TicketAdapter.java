...
//        Picasso.with(holder.itemView.getContext()).load(listItem.getImageURL()).into(holder.imageView);
            ...
            holder.ticketList.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent itemDetailIntent = new Intent(view.getContext().getApplicationContext(), com.example.daredevil07.ItsShowTime.TicketDetailActivity.class);

                    itemDetailIntent.putExtra("MyFilmAdapter", ticket);
